...
pages_crawled = 0
while queue and pages_crawled < 5:
    raw_url = queue.pop(0)
...
# Save to CSVs
df_dom.to_csv("site_full_dom_h.csv", index=False)
df_visible.to_csv("site_visible_content_h.csv", index=False)
...
df_images.to_csv("site_images_h.csv", index=False)
...
df_forms.to_csv("site_forms_flat_h.csv", index=False)
